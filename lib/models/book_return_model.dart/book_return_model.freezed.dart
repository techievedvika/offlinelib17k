    ...
    return _then(_value.copyWith(
      ...
      school: null == school
          ...
          : school // ignore: cast_nullable_to_non_nullable
              as String,
      studentnclass: null == studentnclass
...
class _$BookReturnModelImpl implements _BookReturnModel {
  _$BookReturnModelImpl(
      ...
      @JsonKey(name: 'class') required this.studentnclass,
      ...
      @JsonKey(name: 'publisher') required this.publisher,
      @JsonKey(name: 'author') required this.author,
      @JsonKey(name: 'language') required this.language,
      @JsonKey(name: 'gener') required this.gener,
...
abstract class _BookReturnModel implements BookReturnModel {
  factory _BookReturnModel(
          ...
          @JsonKey(name: 'class') required final String studentnclass,
          ...
          @JsonKey(name: 'publisher') required final String publisher,
          @JsonKey(name: 'author') required final String author,
          @JsonKey(name: 'language') required final String language,
          @JsonKey(name: 'gener') required final String gener,
